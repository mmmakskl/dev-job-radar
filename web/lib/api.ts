...
export type Metrics = { date:string; timezone:string; counts:{posts_processed:number;vacancies_added:number;skipped:number;errors:number}; reasons:Record<string,number>; description:string };
